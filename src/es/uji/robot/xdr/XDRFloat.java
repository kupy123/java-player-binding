...
public class XDRFloat implements XDRObject{
	...
	public XDRFloat(byte[] buffer, int idx, int len) throws XDRException{
	 ...
	 * Encodes a XDR Float
	 * 
	 * @return XDR Float encoding information 
	 */

	public byte[] toXDR(){
		return new XDRInt((int)(Float.floatToIntBits(this.getValue()))).toXDR();
	}
	
	/**
	 * Decodes an XDR Float
	 * 
...
//		}
		XDRInt n = new XDRInt(buffer,idx,len);
		this.value = Float.intBitsToFloat((int)n.getValue());
	}
